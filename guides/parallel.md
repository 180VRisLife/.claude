# Parallel Execution and Agent Management Guide for Default Development
...
- **Interface dependencies**: Interfaces, types, and definitions that other code relies on
- **Core utilities**: Shared functions, helpers, and base classes
- **Database schemas**: Entity definitions and migrations that affect data access
...
1. Implementation tasks → @implementor
...
Stage 2: Parallel @implementor agents for service layer and UI components
Stage 3: @implementor agents for tests + documentation
```

### Pattern 2: Feature-Based Parallelization
```
Stage 1: Multiple @implementor agents for independent features
...
Stage 3: Parallel @implementor agents for implementation
```
