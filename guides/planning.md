...
**For Standard Tasks:**
"Deploy single @implementor agent with context from models/* and interfaces/*"

**For Complex Tasks:**
```
Phase 1: Parallel execution
- @implementor: Views, components, and visualizations
- @code-finder: Database and API sync discovery
...
#### Task 2.1: Service Layer [@implementor]
Read first:
- models/User.js
...
#### Task 2.2: UI Components [@implementor]
Read first:
- models/User.js
