...
**Deep Pattern Analysis**: Deploy code-finder-advanced for semantic understanding across large Swift codebases where simple searches miss conceptual connections.
...
**Analysis & Synthesis**:
- `Task(code-finder-advanced)`: Semantic Swift understanding, architectural analysis
