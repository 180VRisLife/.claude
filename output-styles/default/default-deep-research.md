...
**Deep Pattern Analysis**: Deploy default-core-code-finder-advanced for semantic understanding across large codebases where simple searches miss conceptual connections.
...
<parameter name="subagent_type">default-core-code-finder-advanced</parameter>
</invoke>
<invoke name="Task">
...
<parameter name="subagent_type">default-core-implementor</parameter>
</invoke>
</function_calls>
</parallel_research_example>
...
**Analysis & Synthesis**:
- `Task(default-core-code-finder-advanced)`: Semantic understanding, architectural analysis
...
6. **Complex pattern analysis?** → Deploy default-core-code-finder-advanced for semantic understanding
