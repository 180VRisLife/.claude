...
**Deep Pattern Analysis**: Deploy visionos-core-code-finder-advanced for semantic understanding across large Swift codebases where simple searches miss conceptual connections.
...
<parameter name="subagent_type">visionos-core-code-finder-advanced</parameter>
</invoke>
<invoke name="Task">
...
<parameter name="subagent_type">visionos-core-implementor</parameter>
</invoke>
</function_calls>
</parallel_research_example>
...
**Analysis & Synthesis**:
- `Task(visionos-core-code-finder-advanced)`: Semantic Swift understanding, architectural analysis
...
6. **Complex pattern analysis?** → Deploy visionos-core-code-finder-advanced for semantic understanding
