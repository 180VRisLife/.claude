...
**Large Investigations**: Deploy visionos-core-code-finder agents for pattern discovery across unfamiliar codebases where manual searching would be inefficient.
