...
**Extend Existing Foundations**: When implementing, leverage existing interfaces, protocols, extensions, and patterns. Extend and modify what exists to maintain consistency.
...
- Look up actual types rather than using dynamic types - precision matters
...
- Note any existing utilities or interfaces you extended
...
4. **Type Precision**: Avoid dynamic types. Research and use exact types from the codebase or framework documentation.
