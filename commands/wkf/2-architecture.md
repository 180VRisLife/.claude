I need to create a `.docs/plans/[feature-name]/architecture.md` document containing high-level technical information on files, patterns, and architecture relevant to implementing a new feature.
...
- Database entities, schemas, or data models
- Established patterns or conventions in the codebase
- Utility files, configuration, or shared modules
...
Each agent should:
- Investigate a specific aspect (e.g., "database schema", "authentication patterns", "UI components")
...
- **Relevant Files**: Each with a brief description of its purpose
- **Database Entities/Schemas**: Tables, collections, or data structures
