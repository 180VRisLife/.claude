I need to create a `.docs/plans/[plan-dir]/shared.md` document containing high level information on files and architectures relevant to a new visionOS feature.
...
The shared.md should name relevant files, Core Data entities, patterns, and docs, each with a brief description, using the template `/Users/chrisjamesbliss/.claude/file-templates/visionos/visionos-shared.template.md`. It should also list other relevant files, like utility files, configuration plists, and whatever else will be used to implement the feature.
