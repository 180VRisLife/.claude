...
The shared.md should name relevant files, entities, patterns, and docs, each with a brief description, using the template `/Users/chrisjamesbliss/.claude/file-templates/default/default-shared.template.md`. It should also list other relevant files, like utility files, configuration files, and whatever else will be used to implement the feature.
