...
- Name relevant action classes, SDK types, or manifest entries, if any
...
- Name the agent that should be used for that task (e.g. `action`, `ui`, `integration`)
