# Investigation Workflow for Streamdeck Development
...
2. **Deploy appropriate agents**:
   ...
   - Example split: Action handlers, Property Inspectors, integration services
...
<function_calls>
  <invoke name="Task">
    <parameter name="description">Investigate action layer</parameter>
    <parameter name="subagent_type">base/code-finder-advanced</parameter>
    <parameter name="prompt">Deep analysis of action event flows...</parameter>
  </invoke>
  <invoke name="Task">
    <parameter name="description">Investigate integration layer</parameter>
    <parameter name="subagent_type">base/code-finder-advanced</parameter>
    <parameter name="prompt">Trace external API integration...</parameter>
  </invoke>
</function_calls>
```
