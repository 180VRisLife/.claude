...
**Extend Existing Foundations**: When implementing, leverage existing interfaces, extensions, and patterns. Extend and modify what exists to maintain consistency.
