I want to define a new feature, eventually resulting in a `.docs/plans/[feature-name]/requirements.md` file. This requirements document should follow the template in `$CLAUDE_HOME/file-templates/requirements.template.md`. Your job is to help me clarify what needs to be built from a user perspective.
...
**Focus areas:**
- **User experience**: What the user sees, does, and expects
- **Functional requirements**: What capabilities the system must provide
