Execute an iOS implementation plan with support for resuming, iterative feedback, and phase-by-phase review.
...
Files: /path/to/View.swift, /path/to/ViewModel.swift
