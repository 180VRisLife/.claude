Create a `.docs/plans/[feature-name]/parallelization.md` document breaking down iOS implementation into parallel tasks using `$CLAUDE_HOME/file-templates/parallelization.template.md`.
