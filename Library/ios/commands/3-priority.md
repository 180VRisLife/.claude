I need to create a `.docs/plans/[feature-name]/priority.md` document that ruthlessly prioritizes iOS features into a 3-tier system.
...
- **New iOS App**: No .claude/, few commits, minimal files → MVP focus, ruthless stubbing
- **Feature Addition**: Established app → Core feature focus, minimal changes to existing Views

Ask: "I detected this is a [new iOS app/feature addition]. Correct?"

### 3. Prioritization Strategy

**New iOS Apps (MVP Focus):**
- Ask: "What's the absolute minimum for v0.1 to deliver value to iOS users?"
- Most features → Tier 2 (stub) or Tier 3 (future)

**Feature Additions (Minimal Change):**
- Ask: "What's the minimal change needed for this iOS feature?"
...
**Tier 1: Build Now** - Only absolute essentials for iOS feature to function
...
**Rules:**
- Be RUTHLESS, especially for new iOS apps
