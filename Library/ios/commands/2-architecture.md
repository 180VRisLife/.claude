I need to create a `.docs/plans/[feature-name]/architecture.md` document containing high-level technical information on Swift files, iOS patterns, and architecture relevant to implementing a new feature.
...
- Relevant Swift files and their purposes (Views, ViewModels, Models, etc.)
...
Each agent should:
- Investigate a specific aspect (e.g., "Core Data schema", "authentication flow", "SwiftUI components")
...
- **Relevant Patterns**: Established iOS conventions with examples
