...
The shared.md should name relevant files, Core Data entities, patterns, and docs, each with a brief description, using the template `$CLAUDE_HOME/file-templates/shared.template.md`. It should also list other relevant files, like utility files, configuration plists, and whatever else will be used to implement the feature.
