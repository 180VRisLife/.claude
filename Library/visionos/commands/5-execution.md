Execute a visionOS implementation plan with support for resuming, iterative feedback, and phase-by-phase review.
...
**Agent Orchestration:**
Ensure compatible contracts (e.g., RealityKit entity interfaces, spatial data bindings). Coordinate to prevent conflicts.
...
Files: /path/to/ImmersiveView.swift, /path/to/RealityKitComponent.swift
...
Next steps:
1. Run app in simulator/device and test spatial feature
2. Review changes
3. Commit: /git
```
