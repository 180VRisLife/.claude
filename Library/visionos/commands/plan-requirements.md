...
- Technical implementation: How we'll build it — including SwiftUI views, RealityKit entities, data models, and CloudKit as needed.
- Assumptions and constraints: Any important limits or spatial context we should account for.
