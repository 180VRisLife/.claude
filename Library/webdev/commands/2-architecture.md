I need to create a `.docs/plans/[feature-name]/architecture.md` document containing high-level technical information on files, React patterns, and architecture relevant to implementing a new web feature.
...
- Relevant files and their purposes (Components, hooks, API routes, etc.)
- Data fetching and state management (React Query, Context, Zustand, etc.)
- Established patterns or conventions (component structure, hooks usage, API design)
...
Each agent should:
- Investigate a specific aspect (e.g., "API endpoints", "authentication flow", "component library")
- Write findings to `.docs/plans/[feature-name]/[research-topic].docs.md`
- List ALL files relevant to their search topic
...
- **Relevant Files**: Each file with a brief description of its purpose
- **Data Models/API Schemas**: Database schemas, API types, or data structures
- **Relevant Patterns**: Established conventions with examples
