...
<example>
Context: User wants Next.js routing documentation.
user: "Get me the latest Next.js App Router documentation and save it to docs/"
assistant: "Let me use the library-docs-writer agent to retrieve current Next.js App Router docs and create a compressed reference."
<commentary>
