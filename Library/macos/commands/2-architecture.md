I need to create a `.docs/plans/[feature-name]/architecture.md` document containing high-level technical information on Swift files, macOS patterns, and architecture relevant to implementing a new feature.
...
- Relevant Swift files and their purposes (Views, ViewControllers, Models, etc.)
- Data persistence (Core Data, SwiftData, UserDefaults, etc.)
- Established patterns or conventions (MVVM, Coordinator, Combine, async-await)
- Shared components, utilities, or services
- External frameworks or SDKs used
...
Each agent should:
- Investigate a specific aspect (e.g., "Core Data schema", "window management", "AppKit components")
...
- **Data Models/Persistence**: Core Data entities, SwiftData models, or other data structures
- **Relevant Patterns**: Established macOS conventions with examples
