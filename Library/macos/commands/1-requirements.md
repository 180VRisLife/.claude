I want to define a new macOS feature, eventually resulting in a `.docs/plans/[feature-name]/requirements.md` file. This requirements document should follow the template in `$CLAUDE_HOME/file-templates/requirements.template.md`. Your job is to help me clarify what needs to be built from a user perspective.
...
- Existing similar Views, ViewControllers, or AppKit patterns
...
**Focus areas:**
- **User experience**: What the user sees, interacts with, and expects from the macOS application
...
"Here's what I understand about this macOS feature:
...
- **User-focused**: Describe from the macOS user's perspective
